...
namespace trackitback.Migrations
{
    ...
    [Migration("20220313022937_addinvestmentOften")]
    partial class addinvestmentOften
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("trackitback.Models.Goal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("trackitback.Models.Spending", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("trackitback.Persistence.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("trackitback.Persistence.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("trackitback.Models.Spending", b =>
                {
                    b.HasOne("trackitback.Models.Bill", "Bill")
                        .WithMany("Spendings")
